...
export default function Contact() {
  return (
    <section id="contact" className="bg-gray-800 p-10 rounded-xl text-white">
      ...
      >
        ...
        <div>
          ...
          <input 
            ...
            name="name" 
            required 
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-3 text-gray-900 focus:ring-indigo-500 focus:border-indigo-500" 
          />
        </div>
